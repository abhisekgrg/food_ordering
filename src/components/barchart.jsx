...
const BarChart = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto py-10 px-4 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-bold text-center mb-8">Orders Bar Chart</h2>
      <div className="flex">
        {/* Y-axis Labels */}
        ...
        {/* Bar Chart */}
        <div className="flex justify-between items-end h-80 space-x-4 w-full">
          {data.map((item, index) => (
            <div
              key={index}
            ...
            >
              {/* Bar */}
              <div
                className="bg-green-500 w-10 rounded-t-lg transition-all duration-300 ease-in-out hover:bg-green-600"
